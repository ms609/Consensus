...
Jansson et al. (2016) give an optimal \\O(kn)\\ algorithm for this
consensus, implemented in their FACT toolkit; here the same tree is
computed directly from the pooled splits.
