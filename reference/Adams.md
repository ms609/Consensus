...
This implementation follows Adams' original recursive definition, as
ported from the FACT toolkit of Jansson and colleagues (used with
permission); their asymptotically faster \\O(kn \log n)\\ algorithm
(Jansson et al. 2017) is not employed here.
