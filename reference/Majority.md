...
The majority-rule consensus belongs to the family of consensus methods
for which Jansson and colleagues developed asymptotically efficient
algorithms (Jansson et al. 2016) – the algorithmic backbone of this
package – and which their FACT toolkit implements. This particular
method is a thin wrapper around
[`TreeTools::Consensus()`](https://ms609.github.io/TreeTools/reference/Consensus.html),
to which the computation is delegated.
