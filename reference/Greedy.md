...
An asymptotically efficient algorithm for the greedy consensus was given
by (Jansson et al. 2016) and implemented in their FACT toolkit; here the
same tree is computed directly from the pooled splits ranked by
frequency.
